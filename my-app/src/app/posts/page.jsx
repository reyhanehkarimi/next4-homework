  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={posts.length > 0 ? `Featured: ${posts[0].body.slice(0, 150)}` : "Browse through a collection of posts on various topics."} />
        <meta property="og:title" content={posts.length > 0 ? `Posts List : ${posts[0].title}` : "Posts List"} />
        <meta
    property="og:description"
    content={posts.length > 0 ? `Explore: ${posts[0].body.slice(0, 150)}` : "Explore a variety of posts on different topics and enjoy reading!"}
  />
      </Head>
